...
def parse_args():
    ...
    parser.add_argument('--content', type=str, default='images/cat.png', help='File path of content image (notation in the paper : p)', required = True)
    parser.add_argument('--style', type=str, default='images/style_cow.png', help='File path of style image (notation in the paper : a)', required = True)
    ...
    parser.add_argument('--content_layers', nargs='+', type=str, default=['relu4_2', 'relu5_2'], help='VGG19 layers used for content loss')
    ...
    parser.add_argument('--content_layer_weights', nargs='+', type=float, default=[1.0, .0], help='Content loss for each content is multiplied by corresponding weight')
